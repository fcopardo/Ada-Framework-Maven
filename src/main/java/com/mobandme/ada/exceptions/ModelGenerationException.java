...
public class ModelGenerationException extends AdaFrameworkException {
	public ModelGenerationException(String pTableName, String pTableScript, String pMessage, Exception pInnerException) { 
		super(String.format("Error during data model generation. Table: %s, Script: %s, Message: %s", pTableName, pTableScript, pMessage));
